      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-3xl mx-auto px-6 py-12">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-light tracking-tight mb-4 text-center text-zinc-100 font-sans">
            Mau bikin apa <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">hari ini?</span>
          </h1>
        ...
        >
          ...
          <p className="mt-6 text-zinc-500 text-sm text-center">
            Mulai dari ide kasar, biarkan kami yang merumuskan menjadi rencana development yang siap dipakai AI.
          </p>
        </motion.div>
      </div>
      ...
      <footer className="relative z-10 px-6 sm:px-10 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-5xl mx-auto mt-auto">
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">Setiap input tersimpan di Database kami.</p>
          </div>
        </div>
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">Siap paste ke AI Agent Coding andalanmu.</p>
          </div>
        </div>
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">Arsitektur minim halusinasi, langsung rapi.</p>
          </div>
        </div>
      </footer>
    </main>
